...
'        Dim filterStatus As String = ""
'        ' cmbFilter is the filter ComboBox added to the form
'        If cmbFilters.SelectedIndex > 0 Then
'            filterStatus = cmbFilters.SelectedItem.ToString().ToLower()
'        End If
...
'        cmbFilters.Items.Add("Cancelled")
'        cmbFilters.SelectedIndex = 0  ' default: show All
